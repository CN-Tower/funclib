...
var fnModules = [
    ...
    _Math_1.FnMath, _Function_1.FnFunction, _Url_1.FnUrl, _Cookie_1.FnCookie, _Dom_1.FnDom, _Trick_1.FnTrick
];
...
fn.log = function (value, configs, isFmt) {
    return _Loger_1.FnLoger.log(true, value, configs, isFmt);
};
module.exports = fn;
...
var FnDom = /** @class */ (function () {
    ...
    FnDom.pollingEl = function (selector, timeout, options, callback) {
        if ((_Type_1.FnType.typeOf(selector, ['str', 'arr'])) && typeof timeout === 'number') {
            ...
            callback = _Type_1.FnType.typeValue(callback, 'func') || _Type_1.FnType.typeValue(options, 'func');
            var count_1 = 0;
            _Time_1.FnTime.interval(selector, duration_1, function (eles) {
                parseInt(String(timeout / duration_1), 10) <= count_1 ? _Time_1.FnTime.interval(selector, false) : count_1++;
                var tmpArr = [];
