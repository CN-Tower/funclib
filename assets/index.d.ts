 ...
 * fn.escape                 同: fn.encodeHtml
 * fn.unescape               同: fn.decodeHtml
...
interface Funclib {
   ...
   * @param source
   * @param cases
   * @param isExec [boolean] 默认为true
   */
  match(source: string, cases: Object, isExec?: boolean): any;
  /**
   * [fn.pretty] 转换成格式化字符串
   * @param obj
   */
   ...
   * @param isNoLimit
   */
  matchPattern(src: string, type: string | string[], isNoLimit?: boolean): any;
  /**
